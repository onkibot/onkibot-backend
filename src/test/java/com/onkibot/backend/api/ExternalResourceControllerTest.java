...
public class ExternalResourceControllerTest {
    ...
    public void testGetExternalResourceWithAuthentication() throws Exception {
        ...
        assertResponseModel(externalResource, mapper.readValue(jsonString, ExternalResourceModel.class));
    }
    ...
    private ExternalResource createRepositoryExternalResource(Resource resource, User publisherUser) {
        ...
        ExternalResource externalResource =
                new ExternalResource(
                        resource, UUID.randomUUID().toString(), publisherUser);
    ...
    private void assertResponseModel(ExternalResource externalResource, ExternalResourceModel responseModel)
            throws IOException {
        assertEquals((int) externalResource.getExternalResourceId(), responseModel.getExternalResourceId());
        assertEquals((int) externalResource.getResource().getResourceId(), responseModel.getResourceId());
        assertEquals(
    ...
    private void assertInputModel(
            ...
            String jsonString)
            throws IOException {
        ExternalResourceModel responseExternalResourceModel = mapper.readValue(jsonString, ExternalResourceModel.class);
        ...
        assertEquals(
                (int) publisherUser.getUserId(), responseExternalResourceModel.getPublisherUser().getUserId());
